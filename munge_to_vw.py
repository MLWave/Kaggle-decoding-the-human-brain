"""
Description: Munge the data, generate features, create 
Vowpal Wabbit train and test set
...
Many thanks to and some code reused from Emanuele Olivetti:
...
loc_data_dir_train = "d:\\traindata\\*.mat" 
loc_data_dir_test = "d:\\testdata\\*.mat"

#will be created
loc_vw_train = "d:\\face.train.vw"
loc_vw_test = "d:\\face.test.vw"
